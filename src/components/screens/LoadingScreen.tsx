    ...
    return (
        <CenterWrapper>
            {loadingProgress < 125 ?
                ...
                <div>
                    { /* Load animation */ }
                    <TextWrapper className="justify-center items-center text-[1.2vmin]" animate={false}>{loadPrompt}</TextWrapper>

                    { /* Progress bar */ }
                    <div className={`
                        w-[80vw] h-[40px] pointer-events-none
                        text-center mt-[20px] text-[1.2vmin]
                    `}>
                ...
                <AsciiWrapper className="top-[0%] text-[1.8vmin]">
                    {AsciiBanner}
                </AsciiWrapper>
            }
            { /* Show ASCII logo if progress bar reaches 100% */ }
            <AsciiWrapper className="top-[5%] text-[0.5vmin]">
